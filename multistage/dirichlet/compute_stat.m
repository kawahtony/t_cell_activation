function [P_bind, tau_bind, sig_bind] = compute_stat(D, mu_0, f, k_01, p, N, ...
...
rho0bar_hat = compute_laplace_rho0bar(D, f, k_01, mu_0, N, ...
                                        Vnmat, Vninvmat, Vcmat, Vcinvmat, ...
...
drho0bar_hat = compute_laplace_drho0bar(D, f, k_01, mu_0, N, ...
                                        Vnmat, Vninvmat, Vcmat, Vcinvmat, ...
                                        lambda_n_vec, lambda_c_vec, tol) ;
...
d2rho0bar_hat = compute_laplace_d2rho0bar(D, f, k_01, mu_0, N, ...
                                          Vnmat, Vninvmat, Vcmat, Vcinvmat, ...
                                          lambda_n_vec, lambda_c_vec, tol) ;
